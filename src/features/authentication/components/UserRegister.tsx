    ...
    <>
      ...
      <div className="w-full pt-5 px-6 py-1 flex flex-col gap-6">
        ...
        <div className="flex gap gap-4 justify-center">
          <a href="">
            {" "}
            <img src="/src/assets/images/icons/Apple Auth.svg" alt="" />
          </a>
          <a href="">
            {" "}
            <img src="/src/assets/images/icons/Facebook Auth.svg" alt="" />
          </a>
          <a href="">
            {" "}
            <img src="/src/assets/images/icons/Google Auth.svg" alt="" />
          </a>
        </div>
